...
from ..models import MEDIA_ASSETS, doc_out, utcnow
...
async def upload_media(file: UploadFile = File(...), alt_text: str | None = Form(None), caption: str | None = Form(None), db: Database = Depends(get_db)):
    ...
    doc = {
        ...
        "alt_text": alt_text, "caption": caption, "kind": kind, "extra": {},
